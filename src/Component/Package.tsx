...
const Package = () => {
     return (
          <div className="lg:container mx-auto lg:px-24">
               ...
               <div className="container px-5 py-20 mx-auto">
                    <div className="flex flex-wrap -m-4">
                         <div className="p-4 lg:w-1/3">
                              <div className="h-full p-5 pt-10 rounded-lg overflow-hidden  s shadow-shadow relative">
                         ...
                         <div className="p-4 lg:w-1/3">
                              <div className="h-full p-5  pt-10 rounded-lg overflow-hidden shadow-shadow relative">
